...
Though Confluent Cloud takes care of managing Zookeeper and the Kafka brokers for you; **currently it doesn't include the ecosystem mentioned before** so you would need to manually provision them by yourself. This project based on [Terraform](https://www.terraform.io) that allows you to have the ecosystem running in the Cloud and automatically connected to the Kafka cluster running on Confluent Cloud. All you have to do is:
